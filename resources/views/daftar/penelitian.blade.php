<x-layout bodyClass="g-sidenav-show bg-gray-200">
    <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
                ...
                <div class="cards card-body mt-4">
                    ...
                    <div class="cards card-plain h-100">
                        ...
                        <div class="card-body p-3">
                            <form method='POST' action="{{ route('penelitian.register') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="file" name="file_penelitian" class="form-control border border-2 p-2">
        ...
        <x-footers.guest></x-footers.auth>
    </div>
    <x-plugins></x-plugins>
</x-layout>
<style>
