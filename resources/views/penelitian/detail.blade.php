            ...
            <div class="card card-body mx-3 mx-md-4 mt-n6">
                ...
                <div class="card card-plain h-100">
                    ...
                    <div class="card-body p-3">
                        <form method="POST" action="{{ route('penelitian.terima', $pendaftaranMagang->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-8 d-flex align-items-center">
                                ...
                                <div class="mb-3 col-md-6">
                                    <label class="form-label">File Proposal Penelitian (PDF)</label>
                                    <a href="{{ route('pdf.show', ['filename' => $pendaftaranMagang->file_penelitian]) }}" target="_blank"><br><i class="fa fa-file-pdf ms-2"></i> View File</a>
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                @if ($pendaftaranMagang->status_pendaftaran == 'Diterima')                                      
                                        <form method="POST" action="{{ route('penelitian.selesai', $pendaftaranMagang->id) }}">
                                            @csrf
                                            @method('PUT')                                            
                                    ...
                                    @elseif ($pendaftaranMagang->status_pendaftaran == 'Pending')
                                        ...
                                        <form method="POST" action="{{ route('penelitian.tolak', $pendaftaranMagang->id) }}">
                                            @csrf
                                            @method('PUT')
